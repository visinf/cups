...
class CustomSemSegFPNHead(nn.Module):
    ...
    def losses(self, predictions, targets):
        ...
        """Targets = targets.flatten(1) predictions = predictions.flatten(2) valid_samples = torch.argwhere(targets !=
        self.ignore_value) loss = ( focal_loss( predictions[valid_samples[:, 0], :, valid_samples[:, 1]],
        targets[valid_samples[:, 0], valid_samples[:, 1]], alpha=0.5,
